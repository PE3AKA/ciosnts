    ...
    private static void executeTest() throws TestException {
        ...
        switch (paramsParser.getTestId()) {
            ...
            case "436024":
                alertManager.defaultHandler();
                acceptanceTests = new AcceptanceTests();
                testCaseInfo.setId(436024L);
                testCaseInfo.setTitle("Comic book - download [bnauto]");
                TestManager.getInstance().setTestCaseInfo(testCaseInfo);
            ...
            case "436025":
                alertManager.defaultHandler();
                acceptanceTests = new AcceptanceTests();
                testCaseInfo.setId(436025L);
                testCaseInfo.setTitle("Comic book - zoom view [bnauto]");
                TestManager.getInstance().setTestCaseInfo(testCaseInfo);
                acceptanceTests.testCase436025();
                break;
            case "436036":
                alertManager.defaultHandler();
                acceptanceTests = new AcceptanceTests();
                testCaseInfo.setId(436036L);
                testCaseInfo.setTitle("Deferred sign in: settings [bnauto]");
                TestManager.getInstance().setTestCaseInfo(testCaseInfo);
                acceptanceTests.testCase436036();
                break;
            case "436037":
                alertManager.defaultHandler();
                acceptanceTests = new AcceptanceTests();
                testCaseInfo.setId(436037L);
